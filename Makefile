NAME = main
OBJECTS = modules/vector.o modules/markers.o modules/dataset.o modules/graph.o modules/waterlevel.o modules/table.o modules/sampler.o modules/infographic.o modules/moisture.o
